...
from tsw6.learning.control_schema import combined_notch_rows, freight_axis_rows
from tsw6.learning.train_labels import (
...
from tsw6.learning.freight_learner import (
...
def main() -> None:
    ...
    if not args.console:
        from tsw6.learning.learn_monitor_gui import main as gui_main
        gui_main()
        return
