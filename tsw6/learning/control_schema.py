...
from tsw6.learning.freight_learner import freight_quantize_level
from tsw6.learning.online_learner import sanitize_vehicle_name
from tsw6.learning.train_labels import FREIGHT_AXIS_ROWS

from tsw6.paths import DATA_DIR, LOGS_DIR

SCHEMAS_DIR = LOGS_DIR / "control_schemas"
...
_FREIGHT_TEMPLATE = _freight_template_path()
...
def schema_path_for_vehicle(name: str) -> str:
    return str(_schemas_dir() / f"{sanitize_vehicle_name(name)}.json")
