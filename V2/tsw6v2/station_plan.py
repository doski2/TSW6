...
Datos reales: distancia HUD, palanca, gradiente, decel aprendida (ETA desactivada).
...
# Plan de andén por distancia HUD. ETA/horario desactivado hasta cablear HUD → planning.
STATION_SCHEDULE_SLACK_ENABLED = False

# ── Horario (Dastsc schedule.ts) — inactivo si STATION_SCHEDULE_SLACK_ENABLED ───
