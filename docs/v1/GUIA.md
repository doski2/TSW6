...
- **Planning límites:** probe UE4SS ~20 Hz (**1** próximo cartel). 2.º límite: no en Lua;
  ...
  notas en [DRIVERAID_API.md](../reference/DRIVERAID_API.md#investigar-2º-límite-lim2).
...
5. En juego: TSW con **`-HTTPAPI`**, servicio comercial → GUI **Planning** muestra `[horario
   ...
   HUD#…]`,
   columnas Llegada/Salida y próxima parada con hora de llegada/salida (validado 2026-08-24).
