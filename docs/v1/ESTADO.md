...
**Regla:** este tablero describe el **runtime actual** (árbol 1–14, tarjetas cerradas, ejemplos E1).
**No** es la lista de trabajo — esa vive solo en [v2/PLAN_V2.md](../v2/PLAN_V2.md).

---

**Referencias:** [FLUJO_FRENOS.md](FLUJO_FRENOS.md) · [CANAL_CONTROL.md](../CANAL_CONTROL.md) ·
[FISICA_Y_APRENDIZAJE.md](FISICA_Y_APRENDIZAJE.md) · [DASTSC_PARITY.md](DASTSC_PARITY.md) ·
...
| `dist_limit2_cm`, `next_limit2_ms` | *no en GetData* | ⬜ [DRIVERAID_API.md — lim2](../reference/DRIVERAID_API.md#investigar-2º-límite-lim2) |
...
| `next_stop`, llegada/salida | — | HUD DB + filtro horario |
...
FSM: abrir Lua/DMI → `STOPPED`; cerrar → `DEPARTING`. OCR de tablón no entra. Heartbeat: `lua=` /
`dmi=`.
...
**Regla histórica E1→C1→C2:** prioridad sugerida en sesiones; el orden canónico de código está en
[v2/PLAN_V2 § Orden](../v2/PLAN_V2.md#orden-de-implementación).
...
| T4 | Horario estaciones (llegada/salida) GUI | `hud_timetable.py` | [HUD_TIMETABLE](HUD_TIMETABLE.md) |
...
### 🎯 Trabajo v2 (no duplicar aquí)

Tarjetas **E1**, **C1**, **C2**, **Pv2**, agente **D1**, etc. → pasos y validación en
[v2/PLAN_V2.md § Orden](../v2/PLAN_V2.md#orden-de-implementación).

| ID | Tema | En plan v2 |
| --- | --- | --- |
| E1 | Validar frenado 323 in-game | Transversal + fase 2 |
| C1 | Señal roja probe + P1 | Pasos 4–5, fase 4 |
| C2 | Distancia andén fina | §4.4, paso 7 (si aplica) |
| Pv2 | Producto `agent/` + paquete | Pasos 2–3, 6–7 |

### ⏸️ Aplazado (referencia — no backlog activo)

| ID | Tema | Nota |
| --- | --- | --- |
| R1 | Estabilidad probe 10+ min | Transversal mantenimiento |
| C3 | Anti-fantasma turnaround | Fuera v2 323 |
| C4 | 2º límite en log | Fase 5 PLAN v2; lim2 aparcado |
| R2 | SD40-2 freight | Fase 6, [FREIGHT_NA](FREIGHT_NA.md) |
...
| ¿Más física del simulador? | Catálogos [TSW_HTTPAPI_INDEX](../reference/TSW_HTTPAPI_INDEX.md) · debate en [CURRENTFORMATION_API](../reference/CURRENTFORMATION_API.md) |
...
1. **Runtime / cerrado:** actualizar tablas y ejemplos E1 cuando cambie el código **actual**.
2. **Pendientes:** solo en [v2/PLAN_V2.md](../v2/PLAN_V2.md) — no reañadir «hacer ahora» aquí.
3. **Detalle probe:** [PENDIENTE_DYNAMICHUD.md](PENDIENTE_DYNAMICHUD.md) (bitácora, no backlog).
4. **Ver diagrama:** preview markdown en Cursor (`Ctrl+Shift+V`) o GitHub.
