...
**Estado (2026-08-28):** ✅ planning de paradas · `station_eta` en P1 · 🔄 holgura con reloj
escenario y tablón fino

**Nomenclatura:** en este doc, **hora de llegada** / **hora de salida** = horario HUD de la próxima
parada. Campos de telemetría: `next_stop_arrival`, `next_stop_departure` (P1: `station_eta` =
llegada normalizada). Ver también [v2/PLAN_V2.md](../v2/PLAN_V2.md) §1.
...
| `next_stop_arrival` | Hora de llegada programada (HUD DB) |
| `next_stop_departure` | Hora de salida programada (HUD DB) |
...
**Estado (2026-08-28):** horarios y llegada/salida en GUI validados. `station_eta` llega a P1;
holgura OFF hasta TimeOfDay. Frenado fino de tablón:
...
| `station_eta` en P1 `station_plan` | ✅ cableado; holgura OFF (reloj PC) |
| Recalcular distancia cada tick con GPS | ❌ (odometría entre polls HTTP ~2 s) |
| Frenado andén `station_plan` | ✅ perfil v2; tablón fino 🔄 |
| OCR «DETÉNGASE EN EL LUGAR» | ❌ (opcional) |

**Resumen:** el planning sabe **qué** parada y **dónde** está el tablón. Horario vs frenada y
plan TimeOfDay: [PENDIENTE_DYNAMICHUD.md](PENDIENTE_DYNAMICHUD.md) § Horario.

---

## Referencias

- [DRIVERAID_API.md](../reference/DRIVERAID_API.md) — `PlayerInfo.geoLocation`, `TrackData.markers`
