...
(`tsw_command_bus.py`); el mod Lua **nunca** usa HTTP — ver
...
[TSW_HTTPAPI_INDEX.md](../reference/TSW_HTTPAPI_INDEX.md). Física del tren (masa, aire, esfuerzos):
[CURRENTFORMATION_API.md](../reference/CURRENTFORMATION_API.md).

Catálogo DriverAid: [DRIVERAID_API.md](../reference/DRIVERAID_API.md).
...
**Backlog:** [v2/PLAN_V2.md](../v2/PLAN_V2.md). Esta tabla = **estado del runtime actual**.
...
| 2.º límite (`lim2`) | Aplazado | [DRIVERAID_API](../reference/DRIVERAID_API.md#investigar-2º-límite-lim2) · fase 5 v2 |
| Horario HUD (`tsw_hud.db`) | ✅ | `hud_timetable.py` |
| Frenado P1 v2 (autopilot) | ✅ | `braking/v2/` — [BRAKE_V2.md](BRAKE_V2.md) |
| Parada andén | ✅ | `v2/station_plan.py` |
| Señal rojo (DANGER) | Diseño ✅ / probe ⬜ | v2 pasos 4–5 |
| Freight SD40-2 | Aplazado | v2 fase 6 · [FREIGHT_NA.md](FREIGHT_NA.md) |
| Canal IPC | ✅ | [CANAL_CONTROL.md](../CANAL_CONTROL.md) |
| Agente `agent/` (D1) | ⬜ | v2 pasos 2–3 |

Probe operativo: [PENDIENTE_DYNAMICHUD.md](PENDIENTE_DYNAMICHUD.md).

---

## Preguntas abiertas

Resueltas o movidas al plan v2 — conservar solo contexto:
